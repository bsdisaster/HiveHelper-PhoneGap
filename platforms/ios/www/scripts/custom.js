$(document).ready(function () {
    ...
    function init_template() {
        ...
        // this is for register login button click to manage page full size
        $('#btnCreateAccount').on('click', function () {

            var content_full_height = $('.page-fullscreen-content').outerHeight();
            $('.page-fullscreen').height(content_full_height);
            $('.page-fullscreen-content').css({
                "margin-top": (content_full_height / 2) * (-1)
            });
        ...
        // this is for register login button click to manage removed unwanted size.
        ...
        $('.myprofile input').on('blur', function () {
            var content_full_height = $('.page-fullscreen-content').outerHeight();
            $('.page-fullscreen').height(content_full_height);
            $('.page-fullscreen-content').css({
                "margin-top": (content_full_height / 2) * (-1)
...
var androidAppVersion = '2.0.6';
var iosAppVersion = '2.0.4';
